...
export function GlobalApiLoader() {
  ...
  return (
    <div className="fixed right-5 top-5 z-[60] flex items-center gap-2 rounded-lg border border-white/10 bg-background/90 px-3 py-2 text-xs font-medium text-muted-foreground shadow-lg shadow-black/20 backdrop-blur-md">
